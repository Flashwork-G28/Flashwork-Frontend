...
const JobDashboardBookingRequest = () => {
                    ...
                    <Table sx={{ minWidth: 400 }} aria-label="customized table">
                        <TableHead>
                            <TableRow>
                                ...
                                <StyledTableCell align="left">Registered Date</StyledTableCell>
                        ...
                        <TableBody>
                            {rows.map((row) => (
                                <StyledTableRow key={row.name}>
                                    ...
                                    <StyledTableCell align="right"><Button href="#text-buttons" sx={{fontSize:'12px'}}>More</Button></StyledTableCell>
...
export default JobDashboardBookingRequest;
